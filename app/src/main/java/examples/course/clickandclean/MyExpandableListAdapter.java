...
public class MyExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public MyExpandableListAdapter(Activity act, SparseArray<Group> groups, boolean check, boolean confirm) {
        activity = act;
        this.groups = groups;
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if(check)
        {
            convertView.findViewById(R.id.checkBox).setFocusable(false);
